...
import { Lock, UtensilsCrossed, ArrowLeft, Eye, EyeOff, Loader2 } from "lucide-react";
...
export function AdminLogin({
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-spice-gradient p-4">
      <div
      ...
      >
        <div className="bg-card rounded-3xl shadow-2xl border border-border/60 p-8 sm:p-10">
          ...
          <div className="flex flex-col items-center text-center mb-8">
            <span className="flex size-16 items-center justify-center rounded-2xl bg-spice-gradient shadow-lg text-white mb-4">
          ...
          <form onSubmit={submit} className="space-y-4">
            ...
            <Button
              type="submit"
              disabled={loading}
              className="w-full h-11 bg-spice-gradient text-white hover:opacity-90"
            >
              {loading ? (
                <>
